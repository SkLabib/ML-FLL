...
def create_model(model_type='efficientnet', model_name=None, num_classes=7, pretrained=True, grayscale=False):
    ...
    if model_type == 'cnn':
        ...
        # Use MobileNetV2 from EfficientNet implementation with appropriate parameters
        model_name = model_name if model_name else 'mobilenet_v2'
        return EfficientNetModel(num_classes=num_classes, pretrained=pretrained, model_name=model_name, grayscale=grayscale)
